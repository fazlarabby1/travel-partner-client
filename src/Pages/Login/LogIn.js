        ...
        <div>
            <div className="md:w-1/2 mx-auto p-4 rounded-md shadow-2xl sm:p-8 bg-sky-800 text-gray-100 mb-10">
                ...
                <div className="my-6 space-y-4">
                    <button onClick={handleGoogleLogin} aria-label="Login with Google" type="button" className="flex items-center justify-center w-full p-4 space-x-4 border rounded-md focus:ring-2 focus:ring-offset-1 border-gray-400 hover:bg-sky-400 focus:ring-violet-400">
